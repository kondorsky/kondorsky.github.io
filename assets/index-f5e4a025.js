...
`;document.addEventListener("DOMContentLoaded",function(){const i=document.querySelector(".product-details"),t=document.createElement("button");t.type="button",t.className="tc-btn",t.textContent="Share & Earn",t.style.marginTop="16px",i.appendChild(t),t.addEventListener("click",function(){const r=document.createElement("div");r.className="tc-promoter-modal",r.innerHTML=`
						...
						<div class="tc-promoter-modal__content">
							...
							<form class="tc-promoter-modal__form">
								...
								<div class="form-group">
									...
									<div class="form-group__row" id="tc_tracking_code">
			...
			`;const n=e.querySelector("#tc_copy_tracking_code");n.addEventListener("click",function(){const d=e.querySelector("#tc_tracking_code");s.copyToClipboard(d.value),n.textContent="Copied",n.style.backgroundColor="#4CAF50",setTimeout(()=>{n.textContent="Copy",n.style.backgroundColor="#007bff"},2e3)})})})});const s={copyToClipboard:function(i){const t=document.createElement("textarea");t.value=i,t.style.position="fixed",t.style.opacity=0,document.body.appendChild(t),t.select(),navigator.clipboard.writeText(t.value).then(()=>{log("Text copied to clipboard")}).catch(r=>{console.error("Failed to copy text: ",r)}),document.body.removeChild(t)}};
